...
def construct_feed_dict(paths,ids,sequences,link_capacity,traffic,labels,placeholders):
    feed_dict = dict()
    feed_dict.update({placeholders['labels']: labels})
    feed_dict.update({placeholders['link_capacity']: link_capacity})
    feed_dict.update({placeholders['paths']: paths})
    feed_dict.update({placeholders['ids']: ids})
    feed_dict.update({placeholders['sequences']: sequences})
    feed_dict.update({placeholders['traffic']: traffic})
    return feed_dict
